...
public class MainTeleOp extends CommandOpMode {
    ...
    public void initialize() {
        ...
        // Subsystems
        DriveSubsystem drive = new DriveSubsystem(bot.frontLeft, bot.frontRight, bot.backLeft,
                                                  bot.backRight);
        IntakeSubsystem intake = new IntakeSubsystem(bot.intake, 0.75);

        // Commands
        DriveCommand driveCommand = new DriveCommand(drive, gPad1::getLeftX, gPad1::getLeftY,
                                                     gPad1::getRightX);
        // CONTROLS ----------------------------------------------------------------------------------------------------
